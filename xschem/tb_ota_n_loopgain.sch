...
C {devices/vsource.sym} -670 340 0 0 {name=VDPWR value=3.3}
...
C {devices/vsource.sym} -750 620 0 0 {name=VCT1 value=3.3}
C {devices/gnd.sym} -750 650 0 0 {name=l9 lab=GND}
C {devices/vsource.sym} -650 620 0 0 {name=VCT0 value=3.3}
...
*****************************************
.include tb_ota_n_loopgain.save
.control
   save all
   set temp = 27
   set wr_singlescale
...
C {devices/vsource.sym} -460 620 0 0 {name=VCD0 value=3.3}
...
C {devices/code.sym} 770 -410 0 0 {name=MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {gf180mcu_fd_pr/annotate_op.sym} 1000 -360 0 0 {name=h1
descr="Annotate OP"
