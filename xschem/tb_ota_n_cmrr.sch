...
C {devices/vsource.sym} -510 340 0 0 {name=VDPWR value=3.3}
...
C {devices/vsource.sym} -590 620 0 0 {name=VCT1 value=3.3}
C {devices/gnd.sym} -590 650 0 0 {name=l9 lab=GND}
C {devices/vsource.sym} -490 620 0 0 {name=VCT0 value=3.3}
...
C {devices/vsource.sym} -310 620 0 0 {name=VCD0 value=3.3}
...
C {devices/code.sym} 780 -420 0 0 {name=MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {gf180mcu_fd_pr/annotate_op.sym} 1010 -370 0 0 {name=h1
descr="Annotate OP"
