...
VIAS = {
	('met1', None, 'met2', 'h') : [
		( 'm2c',  -130, -130, 130, 130 ),
		( 'met2', -190, -140, 190, 140 ),
	],
	('met1', None, 'met2', 'v') : [
		( 'm2c',  -130, -130, 130, 130 ),
		( 'met2', -140, -190, 140, 190 ),
	],
	('met2', 'h', 'met3', 'v'): [
		( 'met2', -190, -140, 190, 140 ),
		( 'm3c',  -140, -140, 140, 140 ),
		( 'met3', -140, -190, 140, 190 ),
	],
	('met2', 'v', 'met3', 'h'): [
		( 'met2', -140, -190, 140, 190 ),
		( 'm3c',  -140, -140, 140, 140 ),
		( 'met3', -190, -140, 190, 140 ),
	],
	('met3', 'h', 'met4', 'v'): [
		( 'met3', -190, -140, 190, 140 ),
		( 'via3', -140, -140, 140, 140 ),
		( 'met4', -140, -190, 140, 190 ),
	],
	('met3', 'v', 'met4', 'h'): [
		( 'met3', -140, -190, 140, 190 ),
		( 'via3', -140, -140, 140, 140 ),
		( 'met4', -190, -140, 190, 140 ),
	],
	('met3', 'v', 'met4', 'v'): [
		( 'met3', -140, -190, 140, 190 ),
		( 'via3', -140, -140, 140, 140 ),
...
class Grid:
	...
	FILL = {
		1:  Cell('gf180mcu_fd_sc_mcu7t5v0__fill_1',      1),
		2:  Cell('gf180mcu_fd_sc_mcu7t5v0__fill_2',      2),
		4:  Cell('gf180mcu_fd_sc_mcu7t5v0__fillcap_4',   4),
		8:  Cell('gf180mcu_fd_sc_mcu7t5v0__fillcap_8',   8),
		16: Cell('gf180mcu_fd_sc_mcu7t5v0__fillcap_16', 116),
	}

	TAP = Cell('gf180mcu_fd_sc_mcu7t5v0__filltie', 2)
	...
	def gen_decap(self):
		...
		for row in range(self.height):
			...
			for col in range(self.width):
				...
				if not 'cap' in ci_idx[0].cell.name:
					continue
...
CELLS = { c.name.split('__')[1]:c for c in [
	Cell('gf180mcu_fd_sc_mcu7t5v0__and2_2',     9),
	Cell('gf180mcu_fd_sc_mcu7t5v0__clkbuf_4',  14),
	Cell('gf180mcu_fd_sc_mcu7t5v0__clkbuf_16', 50),
	Cell('gf180mcu_fd_sc_mcu7t5v0__dlyb_2',    18),
	Cell('gf180mcu_fd_sc_mcu7t5v0__dffrnq_1',  34),
]}
